...
# ╔═╡ f9b93042-3db2-4cf5-970e-b1b91ac72ee3
md"""
```
add DifferentialEquations, ModelingToolkit, OrderedCollections, Plots, PlutoUI
```
"""

# ╔═╡ cd420bec-e829-46d6-b526-20e375c0665e
md"""
...
\begin{dcases}
    \begin{aligned}
        ...
        M_{n+1} &= \gamma R_n\left(1-\frac{1}{1 + R_n}\right)
    \end{aligned}
\end{dcases}
}$
"""
...
julia_version = "1.9.0"
manifest_format = "2.0"
project_hash = "86ef4fab37bd56fbf4bb3ecabc0c1a30b2f95e50"
